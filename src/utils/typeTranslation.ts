 ...
 * ```
 */
export type ExtractTranslationKeys<T extends Record<string, Record<string, string>>> = 
 ...
 * ```
 */
export type ExtractLanguageKeys<T extends Record<string, string>> = keyof T & string;
 ...
 * ```
 */
export function createTypedTranslationWithStyles<T extends Record<string, string>>(
  translations: T,
) {
